...
| tr | Turkish | API E2E generated and verified `tmp/e2e-validations/lisoir_dnde442.fr-tr.srt`; strict browser-download validation still pending. |
| it | Italian | API E2E generated and verified `tmp/e2e-validations/lisoir_dnde442.fr-it.srt`; strict browser-download validation still pending. |
