...
HOST = "127.0.0.1"
PORT = 8765
PUBLIC_MODE = os.environ.get("XOLOLINGUA_PUBLIC_MODE", "0") == "1"
PUBLIC_MAX_UPLOAD_BYTES = int(os.environ.get("XOLOLINGUA_PUBLIC_MAX_UPLOAD_BYTES", "2000000000"))
PUBLIC_MAX_JSON_BYTES = 2_000_000
PUBLIC_REQUESTS_PER_HOUR = int(os.environ.get("XOLOLINGUA_PUBLIC_REQUESTS_PER_HOUR", "12"))
PUBLIC_MAX_WORK_BYTES = int(os.environ.get("XOLOLINGUA_PUBLIC_MAX_WORK_BYTES", "10000000000"))
MAX_DURATION_SECONDS = int(2.5 * 60 * 60)
PUBLIC_MAX_DURATION_SECONDS = 60 * 60
