...
const MODEL_ASSET_BOOTSTRAP_URLS = [
  ...
  "models/Xenova/whisper-tiny/added_tokens.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-tiny/config.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-tiny/generation_config.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-tiny/merges.txt?v=browser-model-assets-v1",
  "models/Xenova/whisper-tiny/normalizer.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-tiny/onnx/decoder_model_merged_q4.onnx?v=browser-model-assets-v1",
  "models/Xenova/whisper-tiny/onnx/encoder_model_q4.onnx?v=browser-model-assets-v1",
  "models/Xenova/whisper-tiny/preprocessor_config.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-tiny/quantize_config.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-tiny/special_tokens_map.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-tiny/tokenizer.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-tiny/tokenizer_config.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-tiny/vocab.json?v=browser-model-assets-v1",
