...
const MODEL_ASSET_BOOTSTRAP_URLS = [
  "models/asr/whisper-small/manifest.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/added_tokens.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/config.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/generation_config.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/merges.txt?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/normalizer.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/onnx/decoder_model_merged_q4.onnx?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/onnx/decoder_model_q4.onnx?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/onnx/decoder_with_past_model_q4.onnx?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/onnx/encoder_model_q4.onnx?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/preprocessor_config.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/quant_config.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/quantize_config.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/special_tokens_map.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/tokenizer.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/tokenizer_config.json?v=browser-model-assets-v1",
  "models/Xenova/whisper-small/vocab.json?v=browser-model-assets-v1",
